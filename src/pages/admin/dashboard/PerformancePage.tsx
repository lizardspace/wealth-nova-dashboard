    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center text-green-600 font-medium text-sm">
              ...
              +{performanceDelta.toFixed(1)}% vs benchmark
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardFooter className="border-t pt-4">
          <p className="text-sm text-muted-foreground">
            Les performances passées ne préjugent pas des performances futures. Données mises à jour au 15/04/2024.
          </p>
        </CardFooter>
      </Card>
      ...
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-600">
          La surperformance de 1.6% par rapport au benchmark s'explique principalement par les allocations actions et SCPI. La stratégie d'allocation en actions internationales a permis de dégager un alpha significatif.
        </AlertDescription>
      </Alert>
    </div>
  );
