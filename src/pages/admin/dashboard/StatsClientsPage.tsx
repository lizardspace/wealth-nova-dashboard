      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="min-h-[180px] flex flex-col">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl">
              {activeClients} ({Math.round((activeClients / totalClients) * 100)}%)
            </CardTitle>
          </CardHeader>
          <CardContent className="flex-1 flex items-end">
        ...
        <Card className="min-h-[180px] flex flex-col">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl">
              {completedProfiles} ({Math.round((completedProfiles / totalClients) * 100)}%)
            </CardTitle>
          </CardHeader>
          <CardContent className="flex-1 flex items-end">
            <div className="text-sm text-muted-foreground">Questionnaires finalisés</div>
          </CardContent>
        </Card>
        ...
        <Card className="min-h-[180px] flex flex-col">
          ...
          <CardContent className="flex-1 flex items-end">
            <div className="text-sm text-muted-foreground">Calculé par l'IA Eparnova</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Card className="min-h-[450px] flex flex-col">
          <CardHeader>
            ...
            <CardDescription>Croissance mensuelle sur 12 mois</CardDescription>
          </CardHeader>
        ...
        <Card className="min-h-[450px] flex flex-col">
          <CardHeader>
            ...
            <CardDescription>Segmentation démographique des clients</CardDescription>
          </CardHeader>
          <CardContent className="flex-1">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Card className="min-h-[450px] flex flex-col">
          <CardHeader>
            ...
            <CardDescription>Évaluation IA des situations patrimoniales</CardDescription>
          </CardHeader>
          <CardContent className="flex-1">
            <ChartContainer config={{ clients: { color: '#8B5CF6' } }}>
              <ResponsiveContainer width="100%" height="100%">
        ...
        <Card className="min-h-[450px] flex flex-col">
          <CardHeader>
            ...
            <CardDescription>Principales motivations des clients</CardDescription>
          </CardHeader>
          <CardContent className="flex-1">
            <ChartContainer config={{}}>
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <ChartTooltip content={<ChartTooltipContent />} />
                  <Bar dataKey="value" fill="#8B5CF6" barSize={25} radius={[0, 4, 4, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </CardContent>
