    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="h-[300px]">
            <ChartContainer config={{ clients: { color: "#8B5CF6" } }}>
              <BarChart data={clientsTotalData}>
                <CartesianGrid strokeDasharray="3 3" strokeOpacity={0.4} />
                <XAxis dataKey="month" />
                <YAxis />
                <ChartTooltip content={<ChartTooltipContent />} />
                <Bar name="Nombre de clients" dataKey="clients" fill="var(--color-clients)" barSize={30} radius={[4, 4, 0, 0]} />
              </BarChart>
            </ChartContainer>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="h-[300px]">
            <ChartContainer config={{ clients: { color: "#8B5CF6" } }}>
              <BarChart data={clientsScoreData}>
                <CartesianGrid strokeDasharray="3 3" strokeOpacity={0.4} />
                <XAxis dataKey="score" />
                <YAxis />
                <ChartTooltip content={<ChartTooltipContent />} />
                <Bar name="Nombre de clients" dataKey="clients" fill="var(--color-clients)" barSize={40} radius={[4, 4, 0, 0]} />
              </BarChart>
            </ChartContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="h-[300px]">
            <ChartContainer config={{}}>
              <BarChart data={clientsObjectifsData} layout="vertical">
                <CartesianGrid strokeDasharray="3 3" strokeOpacity={0.4} />
                <XAxis type="number" />
